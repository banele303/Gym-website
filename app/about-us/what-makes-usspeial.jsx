    ...
    <div className="relative h-screen overflow-hidden">
      ...
      >
        <motion.h1
          ...
          transition={{ duration: 3 , spring: 250 }}
          className="text-[22px] md:text-[40px]   font-bold mt-[-12rem] text-blue-400 opacity-90"
        >
        ...
        <motion.p
          variants={headingVariants}
          transition={{ duration: 3, spring:250 }}
          className="text-[17px] md:text-[20px] text-gray-500 text-center text-slate-200 pt-[3rem] px-[2rem]"
        >
