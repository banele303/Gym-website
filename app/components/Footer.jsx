...
const SITEMAP = [
  ...
  {
    title: "Member Ships",
    links: ["Personal Trainer", "Group Training", "Products"],
  },
  {
    title: "Products",
    links: ["Surplements", "Shirts", "Proteins"],
  },
];
...
export function Footer() {
  ...
  return (
    ...
    transition={{ duration: 3, spring: 250}}
      ...
      className="relative py-[5rem] bg-gray-900 w-full">
      <div className="mx-auto w-full max-w-7xl px-8">
            ...
            <div key={key} className="w-full">
              <motion.h3
               ...
               transition={{ duration: 3, spring:250 }}
                variant="small"
                color="blue-gray"
                className="mb-4 text-white font-bold uppercase opacity-80"
              >
                {title}
              </motion.h3>
              <ul className="space-y-1">
                {links.map((link, key) => (
                  <motion.p
                  variants={headingVariants}
                  transition={{ duration: 3, spring:250 }} key={key} as="li" color="" className="text-white font-normal">
                    <a
                      href="#"
                      className="inline-block py-1 pr-2 opacity-50 transition-transform hover:scale-105"
                    >
                      {link}
                    </a>
                  </motion.p>
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">SouthFlow Marketing Agency</a>. All
            Rights Reserved.
          </Typography>
