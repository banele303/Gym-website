...
const TypingText = () => {
  return (
    <div className="App">
      <section className="bg-gray-900 p-[2rem] md:p-[15rem] flex flex-col justify-center items-center">
        ...
        <p className="opacity-0.6 text-[16px] text-gray-400 md:text-[21px] py-[2rem] text-center mx-auto max-w-[850px]">
          At , our members follow a variety of training modalities including
          CrossFit, Starting Strength, Power Monkey Fitness, Onnit, USAW, and
          more. <br /> <br /> You&apos;ll find suggested workouts on our
